...
<body class="bg-[#C8A892]">
    ...
    <section class="max-w-6xl mx-auto py-14">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <!-- Americano -->
            <article class="bg-[#D8B89A] rounded-3xl shadow-lg overflow-hidden flex">
                <img src="{{ asset('images/menu/americano.jpg') }}"
                    class="w-40 md:w-48 h-full object-cover">
        ...
        <!-- ====== NON KOPI ====== -->
        <h2 class="text-3xl md:text-4xl font-extrabold text-[#FF3A20] mt-16 mb-6">Non Kopi</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- ... kartu Non Kopi yang tadi ... -->
        </div>

        <!-- ====== TRADISIONAL ====== -->
        <h2 class="text-3xl md:text-4xl font-extrabold text-[#FF3A20] mt-16 mb-6">Tradisional</h2>
        ...
        <!-- ====== JAJANAN ====== -->
        <h2 class="text-3xl md:text-4xl font-extrabold text-[#FF3A20] mt-16 mb-6">Jajanan</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <article class="bg-[#D8B89A] rounded-3xl shadow-lg overflow-hidden flex">
                ...
                <!-- ====== MAKANAN ====== -->
        <h2 class="text-3xl md:text-4xl font-extrabold text-[#FF3A20] mt-16 mb-6">Makanan</h2>
